...
function Get-WiringProbe {
    @(
        ...
        '# Se vacía primero: la pantalla de inicio (la lista) ya lee el'
        '# registro de las secciones que declaran claves, así que sin'
        '# esto el cajón traería esas líneas además de las de esta lectura.'
        'Clear-AppLog'
